...
export default function ChatPage() {
  ...
  const createSupportTicket = async () => {
    ...
    try {
      // --------------------------------------------------
      // Use the title and summary generated by Gemini
      // --------------------------------------------------
      ...
      // --------------------------------------------------
      // Create ticket through backend API
      // --------------------------------------------------
  ...
  const sendMessage = async (
    ...
    try {
      ...
      if (data.offerTicket) {
        ...
        // Store AI-generated ticket information
        setTicketTitle(
          data.ticketTitle || "Customer Support Issue"
        );
